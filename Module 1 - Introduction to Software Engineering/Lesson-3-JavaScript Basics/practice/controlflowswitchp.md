...
let horseName = 'leftFoot'

switch (position = Math.ceil (Math.random()*5)) {
    case 1:
    ...
    break;
    case 3:
    console.log(horseName + 'finishedin third place!');
    break;
    default:
        console.log(horseName +'did not place in the top 3')
}   
...
```output
leftFootdid not place in the top 3
```